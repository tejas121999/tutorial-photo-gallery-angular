...
@Component({
  selector: "app-round-off-list",
  templateUrl: "./round-off-list.component.html",
  styleUrls: ["./round-off-list.component.scss"],
})
export class RoundOffListComponent implements OnInit {
  pageSize = 15;
  currentPage = 1;
  currentDate: string;
  public data = [];
  ...
  getRoundOffList() {
    ...
    this.apiService.getRoundOffLessList(temp).subscribe(
      (response: any) => {
